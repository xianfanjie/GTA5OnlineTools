...
public static class Offsets
{
    ...
    public const int CPed_CPlayerInfo_SwimSpeed = 0x01C8;                    // float
    public const int CPed_CPlayerInfo_WaterProof = 0x01E0;
    public const int CPed_CPlayerInfo_WalkSpeed = 0x1EC;
    public const int CPed_CPlayerInfo_GameState = 0x0230;                    // byte
    public const int CPed_CPlayerInfo_CPed = 0x0240;
    public const int CPed_CPlayerInfo_FrameFlags = 0x0270;
    public const int CPed_CPlayerInfo_WantedCanChange = 0x078C;              // float
    public const int CPed_CPlayerInfo_NPCIgnore = 0x08C0;                    // int32
    public const int CPed_CPlayerInfo_WantedLevel = 0x08D8;                  // int32
    public const int CPed_CPlayerInfo_WantedLevelDisplay = 0x08DC;           // int32
    public const int CPed_CPlayerInfo_RunSpeed = 0x0D40;                     // float
    public const int CPed_CPlayerInfo_Stamina = 0x0D44;                      // float
    public const int CPed_CPlayerInfo_StaminaRegen = 0x0D48;                 // float
    public const int CPed_CPlayerInfo_WeaponDamageMult = 0x0D5C;             // float
    public const int CPed_CPlayerInfo_WeaponDefenceMult = 0x0D60;
    public const int CPed_CPlayerInfo_MeleeWeaponDamageMult = 0x0D68;
    public const int CPed_CPlayerInfo_MeleeDamageMult = 0x0D6C;
    public const int CPed_CPlayerInfo_MeleeDefenceMult = 0x0D70;
    public const int CPed_CPlayerInfo_MeleeWeaponDefenceMult = 0x0D7C;
