...
public static class Offsets
{
    ...
    public const int CPed_CPlayerInfo_WaterProof = 0x1E0;
    public const int CPed_CPlayerInfo_WalkSpeed = 0x1E4;
    public const int CPed_CPlayerInfo_GameState = 0x230;                    // byte
    public const int CPed_CPlayerInfo_CPed = 0x240;
    public const int CPed_CPlayerInfo_FrameFlags = 0x270;
    public const int CPed_CPlayerInfo_WantedCanChange = 0x78C;              // float
    public const int CPed_CPlayerInfo_NPCIgnore = 0x8C0;                    // int32
    public const int CPed_CPlayerInfo_WantedLevel = 0x8D8;                  // int32
    public const int CPed_CPlayerInfo_WantedLevelDisplay = 0x8DC;           // int32
    public const int CPed_CPlayerInfo_RunSpeed = 0xD40;                     // float
    public const int CPed_CPlayerInfo_Stamina = 0xD44;                      // float
    public const int CPed_CPlayerInfo_StaminaRegen = 0xD48;                 // float
    public const int CPed_CPlayerInfo_WeaponDamageMult = 0xD5C;             // float
    public const int CPed_CPlayerInfo_WeaponDefenceMult = 0xD60;
    public const int CPed_CPlayerInfo_MeleeWeaponDamageMult = 0xD68;
    public const int CPed_CPlayerInfo_MeleeDamageMult = 0xD6C;
    public const int CPed_CPlayerInfo_MeleeDefenceMult = 0xD70;
    public const int CPed_CPlayerInfo_MeleeWeaponDefenceMult = 0xD7C;
