...
/// <summary>
/// OnlineWeaponView.xaml 的交互逻辑
/// </summary>
public partial class OnlineWeaponView : UserControl
{
    /// <summary>
    /// 导航字典
    /// </summary>
    ...
    private void CreateView()
    {
        foreach (var item in ControlHelper.GetControls(Grid_NavMenu).Cast<RadioButton>())
        {
            ...
            {
                var type = Type.GetType($"GTA5Menu.Views.OnlineWeapon.{viewName}");
                if (type == null)
                    continue;
