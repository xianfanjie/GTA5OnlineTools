...
public partial class MoneyView : UserControl
{
    ...
    private void Button_Read_Click(object sender, RoutedEventArgs e)
    {
        ...
        TextBox_Casino_Player4.Text = Globals.ReadGA<int>(player_ratio + 4).ToString();

        TextBox_Casino_Lester.Text = Globals.ReadGA<int>(lester_ratio).ToString();

        TextBox_CasinoPotential_Money.Text = Globals.ReadGA<int>(player_money + 1).ToString();
        TextBox_CasinoPotential_Artwork.Text = Globals.ReadGA<int>(player_money + 2).ToString();
        TextBox_CasinoPotential_Gold.Text = Globals.ReadGA<int>(player_money + 3).ToString();
        TextBox_CasinoPotential_Diamonds.Text = Globals.ReadGA<int>(player_money + 4).ToString();

        TextBox_CasinoAI_1.Text = Globals.ReadGA<int>(ai_ratio + 1).ToString();
        TextBox_CasinoAI_2.Text = Globals.ReadGA<int>(ai_ratio + 2).ToString();
        TextBox_CasinoAI_3.Text = Globals.ReadGA<int>(ai_ratio + 3).ToString();
        TextBox_CasinoAI_4.Text = Globals.ReadGA<int>(ai_ratio + 4).ToString();
        TextBox_CasinoAI_5.Text = Globals.ReadGA<int>(ai_ratio + 5).ToString();

        TextBox_CasinoAI_6.Text = Globals.ReadGA<int>(ai_ratio + 6).ToString();
        TextBox_CasinoAI_7.Text = Globals.ReadGA<int>(ai_ratio + 7).ToString();
        TextBox_CasinoAI_8.Text = Globals.ReadGA<int>(ai_ratio + 8).ToString();
        TextBox_CasinoAI_9.Text = Globals.ReadGA<int>(ai_ratio + 9).ToString();
        TextBox_CasinoAI_10.Text = Globals.ReadGA<int>(ai_ratio + 10).ToString();

        TextBox_CasinoAI_11.Text = Globals.ReadGA<int>(ai_ratio + 11).ToString();
        TextBox_CasinoAI_12.Text = Globals.ReadGA<int>(ai_ratio + 12).ToString();
        TextBox_CasinoAI_13.Text = Globals.ReadGA<int>(ai_ratio + 13).ToString();
        TextBox_CasinoAI_14.Text = Globals.ReadGA<int>(ai_ratio + 14).ToString();
        TextBox_CasinoAI_15.Text = Globals.ReadGA<int>(ai_ratio + 15).ToString();
